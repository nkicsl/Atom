...
func opMload(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	//fmt.Println("this is mload begin, time:", time.Now())
        v := callContext.stack.peek()
	offset := v.Int64()
	v.SetBytes(callContext.memory.GetPtr(offset, 32))
	//fmt.Println("this is mload end, time:", time.Now())
	//fmt.Println("This is Mload, v:", v,"offset:",offset)
	return nil, nil
}
...
func opMstore(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	switch val.Int64() {
		...
		default:
			...
			fmt.Println("This is Mstore, mStart:", mStart,"val:",val)
	}	
/*
	if(val.Int64()==77){
		fmt.Println("This is Mstore under 77!")
	...
	if(val.Int64()==83){
		fmt.Println("This is Mstore under 83!")
		code := callContext.contract.Code
		interpreter.evm.StateDB.SetCode(callContext.contract.Address(), code)
		t := time.Now().UnixNano()
		fmt.Println(t)
...
func opSload(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
        //fmt.Println("This is sload begin, time:", time.Now())
	loc := callContext.stack.peek()
	val := interpreter.evm.StateDB.GetState(callContext.contract.Address(), common.BigToHash(loc))
	loc.SetBytes(val.Bytes())
        //fmt.Println("This is sload end, time:", time.Now())
	fmt.Println("This is Sload, loc:", loc,"val:",val)
	return nil, nil
}
...
func opSstore(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	fmt.Println("This is Sstore, loc:", loc,"val:",val)
	return nil, nil
}
